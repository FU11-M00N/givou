...
//    res.header('Access-Control-Allow-Origin', 'http://www.givou.site'); // 허용할 도메인을 지정
//    res.header('Access-Control-Allow-Methods', 'GET, POST, PATCH, DELETE'); // 허용할 메서드를 지정
//    res.header('Access-Control-Allow-Headers', 'Content-Type'); // 허용할 헤더를 지정
//    next();
// });
